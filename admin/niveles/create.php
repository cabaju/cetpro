                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="nivel" id="" class="form-control">
                                                <option value="GESTIÓN 2024">GESTIÓN 2024</option>
                                                <option value="GESTIÓN 2025">GESTIÓN 2025</option>
                                                <option value="GESTIÓN 2026">GESTIÓN 2026</option>
                                                <option value="GESTIÓN 2027">GESTIÓN 2027</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
