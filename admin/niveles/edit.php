...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container">
            <div class="row">
                <h1>Modificar nivel de Gestión: <?=$nivel;?></h1>
            </div>
            <br>
            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="nivel" id="" class="form-control">
                                                <option value="GESTIÓN 2024"<?php if($nivel=='GESTIÓN 2024'){ ?> selected="selected" <?php } ?>>GESTIÓN 2024</option>
                                                <option value="GESTIÓN 2025"<?php if($nivel=='GESTIÓN 2025'){ ?> selected="selected" <?php } ?>>GESTIÓN 2025</option>
                                                <option value="GESTIÓN 2026"<?php if($nivel=='GESTIÓN 2026'){ ?> selected="selected" <?php } ?>>GESTIÓN 2026</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
