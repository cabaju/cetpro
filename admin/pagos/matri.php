...
while ($row = $resultado->fetch_assoc()) {
    ...
    $pdf->Cell(30, 30, '', 0, 1, 'C'); // Celda vacía con borde para el cuadro

    // $pdf->Image('../../public/images/configuracion/risco.jpg', 174, 10, 30);

    $pdf->Ln(7); // Espacio extra si se necesita después de esta sección
    ...
    $pdf->Cell(30, 6.5, utf8_decode(date('Y')), 1, 0, 'C', 0); // Muestra el año actual
    ...
    $pdf->Cell(55, 6.5, utf8_decode($row['estado_civil']), 1, 0, 'C', 0);
    ...
    $pdf->Ln(0);
    $pdf->Cell(65, 6.5, utf8_decode($row['lugar']), 1, 0, 'C', 0);
    ...
    $pdf->Ln(0);
    $pdf->Cell(18.5, 6.5, 'CICLO', 1, 0, 'L', 1);
    $pdf->SetFont('Times','',10);
    $pdf->Cell(30, 6.5, utf8_decode('BÁSICO'), 1, 0, 'C', 0);
    $pdf->SetFont('Times','B',9);
    $pdf->Cell(68, 6.5, utf8_decode('OPCIÓN OCUPACIONAL/ESPECIALIDAD'), 1, 0, 'L', 1);
    $pdf->SetFont('Times','',10);
    $pdf->Cell(78.5, 6.5, utf8_decode($row['curso']), 1, 1, 'L', 0);
    $pdf->Ln(0);
    $pdf->SetFont('Times','B',9);
    $pdf->Cell(18.5, 6.5, utf8_decode('MÓDULO'), 1, 0, 'L', 1);
    $pdf->SetFont('Times','',10);
    $pdf->Cell(76.5, 6.5, utf8_decode($row['paralelo']), 1, 0, 'L', 0);
    $pdf->SetFont('Times','B',9);
    ...
    $pdf->Ln(0);
    $pdf->SetFont('Times','B',9);
    $pdf->Cell(18.5, 6.5, utf8_decode('HORARIO'), 1, 0, 'L', 1);
    $pdf->SetFont('Times','',9);
    $pdf->Cell(56.5, 6.5, utf8_decode($row['frecuencia']), 1, 0, 'L', 0);
    $pdf->SetFont('Times','B',9);
