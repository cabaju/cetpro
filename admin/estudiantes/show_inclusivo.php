                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <a href="../pagos/conadis.php?id=<?=$id_estudiante;?>" class="btn btn-danger btn-lg" target="_blank">conadis PDF</a>
                            <a href="<?=APP_URL;?>/admin/reportes/index.php" class="btn btn-secondary btn-lg">Volver</a>
                        </div>
                    </div>
                </div>
