...
include ('../../app/controllers/estudiantes/listado_de_estudiantes_convenio.php');
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Estudiantes registrados por convenios</h3>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th><center>Grado Actual</center></th>
                                    <th><center>Celular</center></th>
                                    <th><center>I.E. Procedencia</center></th>
                                ...
                                foreach ($estudiantes as $estudiante){
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center"><?= date('d/m/Y', strtotime($estudiante['fyh_creacion'])); ?></td>
                                        <td><?=$estudiante['apellidos']." ".$estudiante['nombres'];?></td>
                                        <td style="text-align: center"><?=$estudiante['ci'];?></td>
                                        <td style="text-align: center"><?= date('d/m/Y', strtotime($estudiante['fecha_nacimiento'])); ?></td>
                                        <td style="text-align: center"><?=$estudiante['ref_nombre'];?></td>
                                        <td><?=$estudiante['celular'];?></td>
                                        <td style="text-align: center"><?=$estudiante['ref_colegio'];?></td>
                                        <td><?=$estudiante['apellido_docente']." ".$estudiante['nombre_docente'];?></td>
                                        <td><?=$estudiante['curso']." | ".$estudiante['paralelo'];?></td>
                                        <!-- <td>
                                            <img src="<?=APP_URL."/public/images/configuracion/".$estudiante['foto'];?>" width="100px" alt="">
                                        </td> -->
                                        <!-- <td>
                                            <?php
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="../estudiantes/show25.php?id=<?=$id_estudiante;?>" type="button" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
                                                <a href="../estudiantes/edit.php?id=<?=$id_estudiante;?>" type="button" class="btn btn-success btn-sm"><i class="bi bi-pencil"></i></a>
