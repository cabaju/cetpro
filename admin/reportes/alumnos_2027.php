...
include ('../../app/controllers/estudiantes/listado_de_estudiantes27.php');
...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <h1>Listado de estudiantes 2027</h1>
            </div>
            <br>
            <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <a href="../estudiantes/show27.php?id=<?=$id_estudiante;?>" type="button" class="btn btn-info btn-sm"><i class="bi bi-eye"></i></a>
