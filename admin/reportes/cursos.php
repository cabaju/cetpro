...
include ('../../app/controllers/kardex/cursos_reporte.php');
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Estudiantes por Cursos</h3>
                            <div class="card-tools">
                                <a href="../reportes/cursos_reporte.php?" class="btn btn-primary btn-lg">Imprimir PDF</a>
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                                ...
                                <tr>
                                    ...
                                    <th style="font-size: 14px;"><center>Curso</center></th>
                                ...
                                foreach ($estudiantes as $estudiante){
                                    ...
                                    $fecha_nacimientos = !empty($estudiante['fecha_nacimiento']) ? date('d/m/Y', strtotime($estudiante['fecha_nacimiento'])) : 'No definida';
                                        ...
                                        <td style="font-size: 14px;"><?=$estudiante['curso'];?></td>
